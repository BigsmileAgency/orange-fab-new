<template>
  <div class="main">
    ...
    <header-sub mainTitle="Discover our<br>Season 5 start-ups!<br><a href='#season5-anchor' class='header_button'>Click here</a></span>" :style="{backgroundImage: 'url(' + require('@/assets/body/header_home.jpg') + ')'}"/>
